...
public class PruebaFigura {
    public static void main(String[] args) {
        ...
        // Triangulo t=new Triangulo(5,4); NO PUEDE SER PORQUE LA CLASE TRIANGULO ES ABSTRACTA
        ...
        tr.dibujarTxt();*/
        int operacion,base,altura,cateto,lado;
        ...
        while(operacion!=5){
           ...
           operacion=Menu(teclado); //Se vuelve a pedir porque sino se quedaria en un bucle infinito
    ...
    static int Menu(Scanner t){
        int opc=0;
        System.out.println("1. Crear el rectangulo");
    ...
    public static void CrearRectangulo(Scanner t, ArrayList<Figura> l){ //Escrito a mano para crear la funcion 1
        int altura,base;
