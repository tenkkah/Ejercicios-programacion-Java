/*Hacer un programa que cree un array cuyo tamaño se pedirá por teclado y cuyo contenido serán números
...
public class Ej3 {
    public static void main(String[] args) {
     ...
     int cantidad;
     System.out.println("Introducir numero de elementos del array");
